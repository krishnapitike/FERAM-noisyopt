...
paramFName=str("log")
paramOpen = open(paramFName,"a")
fopt = minimizeCompass(Fun,bounds=pBounds, x0=p0, deltatol=0.1, paired=False)
#fopt.Bounds(lB, uB, keep_feasible=False)
#bounds=[[7.198686, 8.798394], [24.88671, 30.417090000000005], [-13.283190000000001, -16.235010000000003], [-37.563480000000006, -45.910920000000004], [-1,1], [-1,1], [84.
73004999999999, 103.55895], [114.5754, 140.03660000000002], [44.29593, 54.13947], [34.56927, 42.25133], [-123.39, -150.81], [-36.53181, -44.64999], [-17.40879, -21.27741]]
)
